      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          ...
          <p className="text-xs sm:text-sm text-neutral-300 mt-3">
            Authorized electric two-wheeler showroom and service center serving
            Lailunga, Raigarh, and Kharsia.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="p-4 rounded-xl bg-[#0C0C11] border border-red-950/50 text-xs text-neutral-400 flex items-start gap-2.5">
              ...
              <div>
                ...
                Official telecom numbers and dedicated WhatsApp lines are
                currently in final registration. You may leave an inquiry
                below for immediate showroom callback.
              </div>
            ...
            <div className="p-6 sm:p-8 rounded-2xl sm:rounded-3xl bg-[#0C0C11] border border-red-950/50">
              ...
              >
                ...
                <input
                  type="hidden"
                  name="_subject"
                  value="New Enquiry - Patel Automobiles"
                />
                ...
                <div>
                  ...
                  <p className="text-xs text-neutral-400">
                    Have a query about Zelio, Warivo, or Dynamo models, finance
                    schemes, or battery warranty?
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    <option value="General Showroom Enquiry">
                      General Showroom Enquiry
                    </option>

                    <option value="Vehicle Pricing & On-Road Estimate">
                      Vehicle Pricing & On-Road Estimate
                    </option>

                    <option value="Battery Replacement & Diagnostics">
                      Battery Replacement & Diagnostics
                    </option>

                    <option value="Commercial Loaders Inquiry (3XL / Logix)">
                      Commercial Loaders Inquiry (3XL / Logix)
                    </option>

                    <option value="Dealership Finance & EMI Details">
                      Dealership Finance & EMI Details
                    </option>
                  </select>
                </div>
